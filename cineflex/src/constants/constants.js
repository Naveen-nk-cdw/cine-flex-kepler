export const CONSTANTS = {
    ...
    TRAILER: {
        ...
        SINTEL_DESCRIPTION:
            'Sintel tells the story of a friendship between a girl named Sintel, a baby dragon and the desperate lengths she will go to when that friendship is taken from her. Sintel is created by Blender in 2010 as a set project to demonstrate blender capabilities.',
    ...
    LOGIN_FORM: {
        LOGIN_HEADING: 'Login',
        LOGIN_DESCRIPTION:
            'Logging int CineFLEX will give you access to full videos and movies. You can sut back, relax and watch at your own home.',
        EMAIL_LABEL: 'Email',
