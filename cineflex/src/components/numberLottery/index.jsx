  ...
  return (
    <div className={styles.container}>
        ...
        <>
            ...
            <input className={`${styles.phoneNumberInput} ${phoneNumberError&& styles.error}`} type='tel' min={0} value={phoneNumber} max={9999999999} placeholder={CONSTANTS.NUMBER_LOTTERY.INPUT_PLACEHOLDER} onChange={handleNumberInput} />
