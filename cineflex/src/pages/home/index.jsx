...
const Home = () => {
    ...
    const otherLanguageIcons = CONSTANTS.OTHERLANGUAGE.LANGUAGE_REPRESENTATION.map(
        (letterLabel) => {
    ...
    return (
        <>
            ...
            <div className={styles.homeContainer}>
                <Trailer />
                <div className={styles.shortTeaserHeading}>{CONSTANTS.HOME.SHORT_TEASER}</div>
                <div className={styles.shortTeaserContainer}>{shortTrailers}</div>
                <div>
                    <div className={styles.languageHeading}>{CONSTANTS.OTHERLANGUAGE.HEADING}</div>
                    <div className={styles.otherLanguageContainer}>{otherLanguageIcons}</div>
                </div>
            </div>
        </>
    );
